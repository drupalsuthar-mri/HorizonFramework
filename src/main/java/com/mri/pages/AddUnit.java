...
public class AddUnit {
    ...
    public void Floor()
    {
        page.frameLocator(getFrameSelector(1)).frameLocator(InnerFrame).locator(Floor).fill("Ground");
        page.frameLocator(getFrameSelector(1)).frameLocator(InnerFrame).locator(Floor).press("Tab");
    }
    public void UnitRef(){
        page.setDefaultTimeout(6000);
        page.frameLocator(getFrameSelector(1)).frameLocator(InnerFrame).locator(UnitRef).fill("KMUNI100");
    ...
    public void StartDate() {
        page.frameLocator(getFrameSelector(1)).frameLocator(InnerFrame).locator(StartDate).fill("29/05/2025");
        page.frameLocator(getFrameSelector(1)).frameLocator(InnerFrame).locator(StartDate).press("Enter");

    }
    @SneakyThrows
    public void EndDate(){
        page.frameLocator(getFrameSelector(1)).frameLocator(InnerFrame).locator(EndDate).fill("03/06/2025");
